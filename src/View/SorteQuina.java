 ...
 */
public class SorteQuina extends javax.swing.JFrame {

    /**
     * Creates new form SorteQuina
     */
    public SorteQuina() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Quina-Resultado");
        jPanel1.add(jLabel1);
        jLabel1.setBounds(130, 90, 120, 40);
        ...
        Resultado.setBounds(80, 140, 180, 30);
    ...
    private void NovoJogoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NovoJogoActionPerformed
        ...
        Model.Operacoes.SorteQuina(); //chamando função classe SorteMega de outra biblioteca(Model)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SorteQuina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SorteQuina().setVisible(true);
            }
        });
    }
