 ...
 */
public class SorteTime extends javax.swing.JFrame {

    /**
     * Creates new form SorteTime
     */
    public SorteTime() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Timemania -Resultado");
        jPanel1.add(jLabel1);
    ...
    private void NovoJogoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NovoJogoActionPerformed
        ...
        Model.Operacoes.SorteTime();//chamando função classe SorteMega de outra biblioteca(Model)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SorteTime.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
