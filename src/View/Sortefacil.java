 ...
 */
public class Sortefacil extends javax.swing.JFrame {

    /**
     * Creates new form Sortefacil
     */
    public Sortefacil() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Loto Fácil -Resultado");
        jPanel1.add(jLabel1);
    ...
    private void NovoJogoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NovoJogoActionPerformed
        ...
        Model.Operacoes.SorteFacil();//chamando função classe SorteMega de outra biblioteca(Model)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sortefacil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Sortefacil().setVisible(true);
            }
        });
    }
